...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-neutral-300",
  {
    variants: {
      variant: {
        default:
          "bg-secondary border border-secondaryHover text-textColor hover:bg-secondaryHover dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/90 transition-all duration-300",
        ...
        secondary:
          "bg-textColor text-bgColor hover:bg-textColorHover dark:bg-neutral-800 dark:text-neutral-50 dark:hover:bg-neutral-800/80 transition-all duration-300",
